...
#include "Quaternion_Gimbal.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat UQuaternion_Gimbal::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void UQuaternion_Gimbal::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternion_Gimbal::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternion_Gimbal::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternion_Gimbal::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UQuaternion_Gimbal::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UQuaternion_Gimbal::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
